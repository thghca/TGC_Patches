...
{
    [HarmonyPatch(typeof(DubsBadHygiene.Building_Heater))]
    [HarmonyPatch("Draw")]
    public static class Building_Heater_Draw_Patch
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            {
                if (codes[i].opcode == OpCodes.Ldfld && (FieldInfo)codes[i].operand == typeof(DubsBadHygiene.Building_Heater).GetField(nameof(DubsBadHygiene.Building_Heater.fuelComp)))
                {
